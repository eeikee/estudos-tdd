...
public class Main {
	public static void main(String[] args) {
		...
		System.out.println(l2.ImpostoToString());
		System.out.println(l3.ImpostoToString());
		System.out.println(ps4Usado.ImpostoToString());
		System.out.println(ps4.ImpostoToString());
		System.out.println("-------------------------------------------------------------------");
		...
		System.out.println(americanas.patrimonioToString());
	}
}
